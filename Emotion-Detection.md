...
It is possible to get higher accuracy models with bigger size. This project focused on getting the smallest size (<10MB) and keeping the accuracy.
...
The dataset had error images such as loading error image of the image url, or simple line drawings instead of photos. Some had wrong category labels as well. After removing error data and moving some of them to right category, accuracy improved.

### EDSR

EDSR stands for Enhanced Deep Residual Networks for Single Image Super-Resolution. It upscales images with great quality. I upscaled 48x48 pixel images to 192x192 pixels, without losing much information. This is 16 times of upscaling.

![](images/Emotion-Detection/im16.png) ![](images/Emotion-Detection/28795.png)

After data augmentation and preprocessing, accuracy raised up to 0.8 with training sets.

## Quantization

Quantization for deep learning is the process of approximating a floating point (normally 32bits) neural network with lower bit values (16bits or 8bits). This drastically reduces both the memory requirement and computational cost of the network.
...
![](images/Emotion-Detection/Screenshot-2023-02-23-at-1.34.47-AM.png)
...
![](images/Emotion-Detection/1_kmu_t1iNbOipwozjxCG6og.jpeg)

When we only train with cropped face images, we can expect some classification challenges; they all look similar in terms of human faces. It would be easier to classify according to sex and age, but facial expressions are subtle. Facial landmarks are coordinates of eyes, eyebrows, nose, mouth, and contour. Especially positions of eyes, eyebrows, and mouth show notable changes compared to image pixels of photos. We can add these facial landmark coordinates as concatenated input to the image pixel information. There are several papers showing enhanced performance.

![](images/Emotion-Detection/img_1.png)

### MobileNetV3

![](images/Emotion-Detection/Screenshot-2023-02-23-at-1.50.07-AM.png)

MobileNetV3 shows better accuracy and running time. We can use it as backbone for custom data training.

### CK+ (Extended Cohn-Kanade dataset)

![](images/Emotion-Detection/Screenshot_2021-02-01_at_13.44.53.png)
