...
>  While player wears it, it prevents the swarm of fans from from following
> the player for 5 seconds.  
>
...
>  Flee: when player approaches to them, they run away from the player till
> they reach the safe distance from the player  
...
>  Cat is shaking due to a bumble bee flying around. Player can help it and
> get PR points.  
>  Dog is walking in circle to get attention from the player. Player can reach
> them and get PR points.  
>  When player have interactions with them, they look at the player and heart
> pops up.
...
> Heart Full by [Google.Poly](http://Google.Poly) via Poly Pizza
